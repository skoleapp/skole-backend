    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'This username is taken.'}, max_length=30, unique=True, validators=[django.core.validators.RegexValidator('[A-Za-z0-9ÅÄÖåäö_]+', 'Usernames can only contain letters, numbers, and underscores.')])),
                ('email', models.EmailField(error_messages={'unique': 'This email is taken.'}, max_length=254, unique=True)),
                ('title', models.CharField(blank=True, max_length=100)),
                ('bio', models.TextField(blank=True, max_length=2000)),
                ('avatar', models.ImageField(blank=True, default=None, upload_to='uploads/avatars', validators=[skole.utils.validators.ValidateFileSizeAndType(2, [('image/jpeg', 'JPEG'), ('image/png', 'PNG')])])),
