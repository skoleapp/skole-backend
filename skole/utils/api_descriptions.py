...
RESOURCE_TYPES = f"Return unlimited amount of resource types. {CREATION_TIME_SORTING}"
...
RESOURCES = (
    f"Return resources filtered by query params. {PAGINATED} {CREATION_TIME_SORTING}"
)
