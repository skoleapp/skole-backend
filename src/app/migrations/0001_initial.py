# Generated by Django 2.2.7 on 2020-01-05 11:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('downloads', models.PositiveIntegerField(default=1, null=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('created', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(null=True, upload_to='uploads/resources')),
                ('text', models.TextField(max_length=1000, null=True)),
                ('resource', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='resource_parts', to='app.Resource')),
                ('resource_part_type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='app.ResourcePartType')),
            ],
        ),
        migrations.AddField(
            model_name='resource',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attachment', models.FileField(blank=True, null=True, upload_to='uploads/comment_attachments')),
                ('modified', models.DateTimeField(auto_now=True)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ...
                ('resource_part', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='app.ResourcePart')),
            ],
        ),
        migrations.AddField(
            model_name='city',
