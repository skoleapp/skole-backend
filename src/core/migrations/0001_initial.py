# Generated by Django 2.2.7 on 2019-11-07 17:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', models.DateTimeField(auto_now=True)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('schools', models.ManyToManyField(related_name='subjects', to='core.School')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resource', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='resource_comments', to='core.Resource')),
            ],
        ),
        migrations.AddField(
            model_name='course',
        ...
        migrations.AddField(
            model_name='user',
            name='schools',
            field=models.ManyToManyField(to='core.School'),
        ),
        migrations.AddField(
            model_name='user',
